import { FontWeights, IButtonStyles, IIconProps, IStackStyles, getTheme, mergeStyleSets } from "office-ui-fabric-react";
...
export const stackStyleBtnRow: Partial<IStackStyles> = { root: { marginBottom: 20, justifyContent: "flex-end" } };
